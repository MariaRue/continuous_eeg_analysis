...
hold on 
 ...
 bar(1, falseAlarmRate.groupLevelLong, 'FaceColor',plotVariables.figure6.colours(1,:),'EdgeColor',plotVariables.figure6.colours(1,:))
 ln = plot([ones(nS,1).*1],squeeze(falseAlarmRate.subjectLevelLong),'.','MarkerSize',plotVariables.figure6.falseAlarmRate.MarkerSize,'LineWidth',plotVariables.figure6.falseAlarmRate.LineWidth, 'Color', plotVariables.figure6.falseAlarmRate.Color);
 

 bar(2, falseAlarmRate.groupLevelShort, 'FaceColor',plotVariables.figure6.colours(1,:),'EdgeColor',plotVariables.figure6.colours(1,:))
 ln = plot([ones(nS,1).*2],squeeze(falseAlarmRate.subjectLevelShort),'.','MarkerSize',plotVariables.figure6.falseAlarmRate.MarkerSize,'LineWidth',plotVariables.figure6.falseAlarmRate.LineWidth, 'Color', plotVariables.figure6.falseAlarmRate.Color);
