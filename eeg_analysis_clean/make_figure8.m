...
hold on
for condition = 1:4
    ll(condition) = plot(timeBins, selectedData{condition}.avg,'-', 'LineWidth', plotVariables.figure4.LineWidth, 'Color', plotVariables.figure6.colours(condition,:))
end
...
for condition = 1:4
    ...
    scatteroptions = {'MarkerSize' 14 'Color' plotVariables.figure6.colours(condition,:)};
    lineoptions = {'LineWidth' 2 'Color' plotVariables.figure6.colours(condition,:)};
