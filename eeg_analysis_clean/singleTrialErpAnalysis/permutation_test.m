...
switch response_type
    ...
    case 'trialStart'
        switch condition_type
            ...
            case 'condition'
                cfg.latency = [0 6.5]; % time interval over which the experimental conditions will be compared
        end
    ...
    case 'buttonPress'
        ...
        switch condition_type
            ...
            case 'condition'
                cfg.latency =[-2 0]; % time interval over which the experimental conditions will be compared
        end
