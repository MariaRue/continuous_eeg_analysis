function D = tnueeg_spm_eeg_spatial_confounds(S)
%TNUEEG_SPM_EEG_SPATIAL_CONFOUNDS Modified SPM function.
...
% Vladimir Litvak
% modified by L.Weber, 21.03.2018: only use good trials for SVD estimation (l. 117)
