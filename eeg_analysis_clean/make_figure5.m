...
hold on 
% plot frequent ERP
create_ERP_plot(selectedData.Average.Freq.time, selectedData.Average.Freq.avg,selectedData.Average.Freq.se,plotVariables.figure1.ERP.colour(1,:),plotVariables.figure1.LineWidth)
% plot rare ERP
create_ERP_plot(selectedData.Average.Rare.time, selectedData.Average.Rare.avg,selectedData.Average.Rare.se,plotVariables.figure1.ERP.colour(2,:),plotVariables.figure1.LineWidth)
...
hold on 
% plot short ERP
create_ERP_plot(selectedData.Average.Short.time, selectedData.Average.Short.avg,selectedData.Average.Short.se,plotVariables.figure1.ERP.colour(3,:),plotVariables.figure1.LineWidth)

% plot long ERP
create_ERP_plot(selectedData.Average.Long.time, selectedData.Average.Long.avg,selectedData.Average.Long.se,plotVariables.figure1.ERP.colour(5,:),plotVariables.figure1.LineWidth)
